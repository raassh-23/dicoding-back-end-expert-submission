...
describe('JwtTokenManager', () => {
  ...
  describe('verifyRefreshToken function', () => {
    it('should throw InvariantError when verification failed', async () => {
      ...
      const accessToken = await jwtTokenManager
          .createAccessToken({username: 'dicoding'});
    ...
    it('should not throw InvariantError ' +
        'when refresh token verified', async () => {
      // Arrange
      const jwtTokenManager = new JwtTokenManager(Jwt.token);
      ...
      // Action & Assert
      await expect(jwtTokenManager.verifyRefreshToken(refreshToken)).resolves
  ...
  describe('decodePayload function', () => {
    it('should decode payload correctly', async () => {
      ...
      // Action
      const {username: expectedUsername} = await jwtTokenManager
